...
doc.store_extractions(doc.invoke_extractor(content_extractor, raw, strategy=Strategy.ALL_TEXT), "etk2_text")
doc.store_extractions(doc.invoke_extractor(content_extractor, raw, strategy=Strategy.MAIN_CONTENT_STRICT), "etk2_content_strict")
doc.store_extractions(doc.invoke_extractor(content_extractor, raw, strategy=Strategy.MAIN_CONTENT_RELAXED), "etk2_content_relaxed")
doc.store_extractions(doc.invoke_extractor(metadata_extractor, raw), "etk2_metadata")
