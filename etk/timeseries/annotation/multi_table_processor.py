...
from annotation.utility import column_orientation
    ...
    def check_for_overlapping_time(cls, date_block, orientation, raw_sheet):
        ...
        if orientation == column_orientation:  # times are in columns
            ...
            if date_block.lower_row - date_block.upper_row >= 2:
                d = date_utilities.parse_row_as_date(raw_sheet[date_block.upper_row][date_block.left_col:date_block.right_col])
                d2 = date_utilities.parse_row_as_date(raw_sheet[date_block.upper_row+1][date_block.left_col:date_block.right_col])
