...
class DateExtractor(Extractor):
    ...
    def parse_date(self, str_date: str,
                   # same params as extract, except for extract_first_date_only
    ...
    def wrap(self, match):
        return Extraction(value=match.group(), start_char=match.start(), end_char=match.end(), extractor_name=self.name)
