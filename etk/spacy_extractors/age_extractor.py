...
def load_age_matcher(nlp):
	...
	matcher.add_pattern("Age",[{LOWER:"age"},{IS_PUNCT:True},{IS_DIGIT:True,LENGTH:2},{IS_PUNCT:True},{IS_DIGIT:True,LENGTH:2}])
...
def extract_age_spacy(doc,nlp,matcher):
	...
	extracts = [wrap_value_with_context(age,doc) for age in processed_matches]
