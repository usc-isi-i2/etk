...
from spacy.attrs import LOWER, IS_ASCII, IS_DIGIT, FLAG18, FLAG19, TAG, DEP, ENT_TYPE
...
def load_movement_matcher(nlp):
	...
	matcher.add_pattern(1, [{LOWER: "last"}, {LOWER: "night"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	...
	matcher.add_pattern(1, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(1, [{LOWER: "out"}, {LOWER: "of"}, {LOWER: "town"}])
	matcher.add_pattern(1, [{LOWER: "outta"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	...
	matcher.add_pattern(1, [{LOWER: "new"}, {LOWER: "girl"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(1, [{LOWER: "recent"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "move"}])
	matcher.add_pattern(1, [{LOWER: "recently"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "move"}])
	...
	matcher.add_pattern(1, [{LOWER: "just"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "arrive"}])
	...
	matcher.add_pattern(1, [{LOWER: "get"}, {LOWER: "here"}, {LOWER: "last"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "night"}])
	...
	matcher.add_pattern(2, [{LOWER: "new"}, {IS_ASCII: True}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {is_place: True}])
	matcher.add_pattern(2, [{LOWER: "new"}, {IS_ASCII: True}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {is_place: True}])
	matcher.add_pattern(2, [{LOWER: "im"}, {LOWER: "new"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(2, [{LOWER: "new"}, {LOWER: "in"}, {is_place: True}])
	matcher.add_pattern(2, [{LOWER: "new"}, {LOWER: "to"}, {is_place: True}])
	matcher.add_pattern(2, [{LOWER: "new"}, {is_girl: True}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	...
	matcher.add_pattern(3, [{LOWER: "grand"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "new"}])
	matcher.add_pattern(3, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "at"}])
	...
	matcher.add_pattern(3, [{LOWER: "area"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "only"}])
	...
	matcher.add_pattern(3, [{LOWER: "best"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "move"}])
	matcher.add_pattern(3, [{LOWER: "next"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "move"}])
	...
	matcher.add_pattern(4, [{LOWER: "town"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "girl"}])
	matcher.add_pattern(4, [{LOWER: "on"}, {LOWER: "the"}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "near"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "down"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "town"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "hall"}])
	matcher.add_pattern(4, [{LOWER: "best"}, {LOWER: "in"}, {LOWER: "town"}])
	#matcher.add_pattern(4, [{LOWER: "best"}, {IS_ASCII: True}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "best"}, {IS_ASCII: True}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "best"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	#matcher.add_pattern(4, [{LOWER: "best"}, {IS_ASCII: True}, {LOWER: "in"}, {IS_ASCII: True}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "best"}, {IS_ASCII: True}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "not"}, {LOWER: "new"}, {LOWER: "in"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	matcher.add_pattern(4, [{LOWER: "not"}, {LOWER: "new"}, {LOWER: "to"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "town"}])
	...
	matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "but"}])
	...
	matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "york"}])
	matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "delhi"}])
	...
	matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "satisfied"}])
	matcher.add_pattern(4, [{LOWER: "leave"}, {LOWER: "memory", DEP: "dobj"}])
	matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "you"}])
	matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "y"}])
	matcher.add_pattern(4, [{LOWER: "leave"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "with"}])
	...
	matcher.add_pattern(4, [{LOWER: "move"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "on"}])
	matcher.add_pattern(4, [{LOWER: "i"}, {LOWER: "move"}, {LOWER: "like"}])
	matcher.add_pattern(4, [{LOWER: "arrive"}, {LOWER: "on"}, {LOWER: "time"}])
	matcher.add_pattern(4, [{LOWER: "can"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "move"}])
	matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "but"}])
	matcher.add_pattern(4, [{LOWER: "move"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "on"}])
	matcher.add_pattern(1, [{LOWER: "on"}, {LOWER: "my"}, {LOWER: "way"},{LOWER: "to"},{TAG: "PRP"}])
	...
	matcher.add_pattern(4, [{LOWER: "new"}, {IS_ASCII: True, 'OP': '?'}, {LOWER: "management"}])
...
def wrap_value_with_context(movement):
	...
	for element in movement:
		this_result = {
				...
				"value": element,
				"metadata": {
						"confidence_level": "movement_"+label_list[movement[element]['ent_id']]
				}
		}
