...
class TestMultiDataExtractor(unittest.TestCase):
    ...
    def test_hostname_extractor(self) -> None:
        text = "check sites brun1989.itldc-customer.net, www.google.com and https://www.google.com go shopping with amazon.com"
        e = HostnameExtractor()
        test_result = [x.value for x in e.extract(text)]
        expected = ["brun1989.itldc-customer.net",
                    "www.google.com",
                    "www.google.com",
                    "amazon.com"
                    ]
    ...
    def test_url_extractor(self) -> None:
        text = "https://foo_bar.example.com/ http://foo_bar.example.com/ https://foobar.example.com/xxx.php  %%%###http://isi.edu/abx  dig.isi.edu/index.html"
        e = URLExtractor(True)
        test_result = [x.value for x in e.extract(text)]
        expected = ["https://foo_bar.example.com/",
