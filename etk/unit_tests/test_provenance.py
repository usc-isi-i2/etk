...
class TestProvenance(unittest.TestCase):
    ...
    def test_Extractable(self) -> None:
      ...
      expected = { "projects": [
                            {
                              "name": "etk", "description": "version 2 of etk, implemented by Runqi, Dongyu, Sylvia, Amandeep and others.",
                              "members": ["Runqi","Dongyu", "Sylvia","Amandeep"]
                            },
                            {
                              "name": "rltk", "description": "record linkage toolkit, implemented by Pedro, Mayank, Yixiang and several students.",
