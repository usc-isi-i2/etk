...
class TestMultiNamespaceValue(unittest.TestCase):
    def test_entity_value(self):
        i = Item('Q34', namespace='dm')
    ...
    def test_time_value(self):
        tv = TimeValue('2019-05-05T00:00:00', Item('Q1985727'), Precision.day, 0, namespace='dm')
    ...
    def test_quantity_value(self):
        qv = QuantityValue(1.5, namespace='dm')
        print(qv._v_name())
    ...
    def test_globe_coordinate(self):
        gc = GlobeCoordinate(45.0, -1, 1, Item('Q405'), namespace='dm')
