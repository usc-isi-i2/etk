...
class TestSpacyRuleExtractor(unittest.TestCase):
    ...
    def test_SpacyRuleExtractor(self) -> None:
        ...
        expected = [('rule_41', 'number:2'), ('rule_30', 'firstName:Runqi12, lastName:Shao'),
                    ('rule_30', 'firstName:Dongyu, lastName:Li'), ('rule_30', 'firstName:Sylvia, lastName:{2}'),
                    ('rule_30', 'firstName:Amandeep, lastName:{2}')]
